...
public class HTTPJwtKeyByOpenIdConnectAuthenticatorTests extends OpenSearchTestCase {

    protected static MockIpdServer mockIdpServer;

    @BeforeClass
    public static void setUpOpenIdConnectAuthenticatorTests() throws Exception {
        mockIdpServer = new MockIpdServer(TestJwk.Jwks.ALL);
    }

    @AfterClass
    public static void tearDownOpenIdConnectAuthenticatorTests() {
