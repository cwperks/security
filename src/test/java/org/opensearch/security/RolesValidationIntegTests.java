...
public class RolesValidationIntegTests extends SingleClusterTest {
    ...
    public void testRolesValidation() throws Exception {
        ...
        try (
            Node node = new PluginAwareNode(
                false,
                tcSettings,
                Lists.newArrayList(Netty4ModulePlugin.class, OpenSearchSecurityPlugin.class, RolesValidationPlugin.class)
            ).start()
        ) {
