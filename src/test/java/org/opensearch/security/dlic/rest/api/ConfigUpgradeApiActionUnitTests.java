...
public class ConfigUpgradeApiActionUnitTests extends AbstractApiActionValidationTest {
    ...
    public void testConfigurationDifferences_OperationBash() throws IOException {
        final var testCases = new ImmutableList.Builder<ConfigUpgradeApiActionUnitTests.OperationTestCase>();
