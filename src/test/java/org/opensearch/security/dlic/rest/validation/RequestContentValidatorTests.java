...
public class RequestContentValidatorTests extends OpenSearchTestCase {
    ...
    public void testPathValidatorRejectsWhitespace() {
        assertValidationThrows(
            ...
            () -> RequestContentValidator.PATH_VALIDATOR.validate("path", "invalid path")
        );
    }
    ...
    public void testArraySizeValidatorFactoryUsesCustomLimit() {
        ...
        assertValidationThrows(IllegalArgumentException.class, () -> validator.validate("arr", node.get("arr")));
    }
    ...
    public void testAllowedValuesValidatorRejectsInvalid() {
        final Set<String> allowed = Set.of("read", "write");
        final RequestContentValidator.FieldValidator validator = RequestContentValidator.allowedValuesValidator(allowed);
        assertValidationThrows(IllegalArgumentException.class, () -> validator.validate("action", "delete"));
    }
    ...
    private static <T extends Throwable> void assertValidationThrows(Class<T> expected, Runnable runnable) {
        try {
            runnable.run();
    ...
    public void testRequireNonEmptyRejectsNull() {
        assertValidationThrows(IllegalArgumentException.class, () -> RequestContentValidator.requireNonEmpty("field", null));
    }

    @Test
    public void testRequireNonEmptyRejectsEmpty() {
        assertValidationThrows(IllegalArgumentException.class, () -> RequestContentValidator.requireNonEmpty("field", ""));
    }
    ...
    public void testValidateMaxLengthRejectsOverLimit() {
        ...
        assertValidationThrows(IllegalArgumentException.class, () -> RequestContentValidator.validateMaxLength("field", value, 5));
    }
    ...
    public void testValidateSafeValueRejectsInvalidCharacters() {
        ...
        assertValidationThrows(IllegalArgumentException.class, () -> RequestContentValidator.validateSafeValue("field", value, 50));
    }

    @Test
    public void testValidateSafeValueRejectsTooLong() {
        String value = repeat('a', 11);
        assertValidationThrows(IllegalArgumentException.class, () -> RequestContentValidator.validateSafeValue("field", value, 10));
    }
    ...
    public void testValidateArrayEntryCountRejectsAboveMax() {
        ...
        assertValidationThrows(IllegalArgumentException.class, () -> RequestContentValidator.validateArrayEntryCount("field", overMax));
    }
