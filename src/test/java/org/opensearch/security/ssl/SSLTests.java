...
public class SSLTests extends SingleClusterTest {
    ...
    public void testCRLPem() throws Exception {
        ...
        final Settings settings = Settings.builder()
            ...
            .put(SSLConfigConstants.SECURITY_SSL_HTTP_CRL_VALIDATION_DATE, CertificateValidatorTests.CRL_DATE.getTime())
            .build();
