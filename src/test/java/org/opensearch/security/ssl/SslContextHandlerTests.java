...
public class SslContextHandlerTests extends OpenSearchTestCase {
    ...
    public void doesNothingIfCertificatesAreSame() throws Exception {
        ...
        assertTrue("SSL Context is the same", sslContextBefore.equals(sslContextHandler.sslContext()));
    }
    ...
    public void reloadSslContext() throws Exception {
        ...
        assertFalse("Context reloaded", sslContextBefore.equals(sslContextHandler.sslContext()));
    }
