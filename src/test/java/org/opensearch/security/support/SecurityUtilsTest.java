...
public class SecurityUtilsTest {
    ...
    private final Collection<String> interestingEnvKeyNames = Arrays.asList(new String[]{
            "=ExitCode",
            "=C:",
            "ProgramFiles(x86)",
    ...
    public void checkInterestingNamesForEnvPattern() {
        checkKeysWithPredicate(interestingEnvKeyNames, "env", ENV_PATTERN.asPredicate());
    }

    @Test
    public void checkRuntimeKeyNamesForEnvPattern() {
        checkKeysWithPredicate(namesFromThisRuntimeEnvironment, "env", ENV_PATTERN.asPredicate());
    }

    @Test
    public void checkInterestingNamesForEnvbcPattern() {
        checkKeysWithPredicate(interestingEnvKeyNames, "envbc", ENVBC_PATTERN.asPredicate());
    }

    @Test
    public void checkInterestingNamesForEnvBase64Pattern() {
        checkKeysWithPredicate(interestingEnvKeyNames, "envbase64", ENVBASE64_PATTERN.asPredicate());
    }
