...
public class SystemIndexAccessEvaluatorTests extends LuceneTestCase {
    ...
    private void testSecurityIndexAccess(String action) {
        ...
        // Action
        PrivilegesEvaluatorResponse response = evaluator.evaluate(request, task, action, resolved, ctx(action), actionPrivileges, user);
