...
public class SecurityRolesTests extends SingleClusterTest {
    ...
    public void testSecurityRolesAnon() throws Exception {
        ...
        setup(
            Settings.EMPTY,
            new DynamicSecurityConfig().setSecurityInternalUsers("internal_users_sr.yml").setConfig("config_anon.yml"),
            Settings.EMPTY,
            true
        );
    ...
    public void testSecurityRoles() throws Exception {
        ...
        setup(
            Settings.EMPTY,
            new DynamicSecurityConfig().setSecurityRolesMapping("roles_mapping.yml").setSecurityInternalUsers("internal_users_sr.yml"),
            Settings.EMPTY,
            true
        );
    ...
    public void testSecurityRolesImpersonation() throws Exception {
        ...
        setup(Settings.EMPTY, new DynamicSecurityConfig().setSecurityInternalUsers("internal_users_sr.yml"), settings, true);
