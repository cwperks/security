...
public class SinkProviderTLSTest {
    ...
    public void testTlsConfigurationNoFallback() throws Exception {
        ...
        Builder builder = Settings.builder()
            .loadFromPath(FileHelper.getAbsoluteFilePathFromClassPath("auditlog/endpoints/sink/configuration_tls.yml"));
        ...
        builder.put(
            "plugins.security.audit.endpoints.endpoint2.config.webhook.ssl.pemtrustedcas_content",
