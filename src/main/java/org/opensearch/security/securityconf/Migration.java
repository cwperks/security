...
public class Migration {
    ...
    public static Tuple<SecurityDynamicConfiguration<RoleV7>, SecurityDynamicConfiguration<TenantV7>> migrateRoles(
        SecurityDynamicConfiguration<RoleV6> r6cs,
    ...
    public static SecurityDynamicConfiguration<ConfigV7> migrateConfig(SecurityDynamicConfiguration<ConfigV6> r6cs)
        ...
        if (r6cs.getCEntries().size() != 1) {
            throw new MigrationException(
                "Unable to migrate config because expected size was 1 but actual size is " + r6cs.getCEntries().size()
            );
        }
